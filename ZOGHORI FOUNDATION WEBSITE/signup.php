    ...
    <div id="id01" class="modal">
        ...
        <form class="modal-content" action="#">
            <div class="container">
                ...
                <input type="text" id="name" name="full-name" placeholder="Enter Your Full Names here" required><br>
                <label for="email"><b>Email</b></label>
                <input type="text" id="mail" placeholder="Enter Email" name="email" required>

                <label for="psw"><b>Password</b></label>
                <input type="password" id="psswd" placeholder="Enter Password" name="psw" required>
